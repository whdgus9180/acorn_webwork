...
<body>
	<div class="container">
		...
		<p>내이름은 <strong>${requestScope.yourName }</strong></p>
		<p>내이름은 <strong>${yourName }</strong></p>
		...
		<p>내이름은 <strong>${sessionScope.ourName }</strong></p>
		<p>내이름은 <strong>${ourName }</strong></p>
		<%-- 위의 EL 은 아래의 코드를 대신할수 있다. --%>
		<%
		...
		<p>내이름은 <strong>${applicationScope.companyName }</strong></p>
		<p>내이름은 <strong>${companyName }</strong></p>
		<%-- 위의 EL 은 아래의 코드를 대신할수 있다. --%>
		<%
			String result3 = (String)application.getAttribute("companyName");
		%>
		<p>너의 이름은 <strong><%=result3 %></strong></p>
	</div>
</body>
</html>
